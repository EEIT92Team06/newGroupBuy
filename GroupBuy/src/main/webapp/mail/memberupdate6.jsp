...
<body>
		...
		<table id="table1">
			...
			<tbody>
				<tr>
					<td colspan="2">
					<div id="dropZone">
							<img src="/GroupBuy/pictures/${MemberInfo.memberPic}" name="pic" />
						</div></td>
				</tr>
				<tr>
				<td><input type="button" value="cancel" onclick="aaa()"></td>
					<td>
	...
	<script type="text/javascript">
		...
		function aaa(){
			var a='<img src="/GroupBuy/pictures/${MemberInfo.memberPic}" name="pic" />'
