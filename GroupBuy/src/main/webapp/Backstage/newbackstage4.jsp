				...
				<div class="productdesc"
					...
					<form action="<c:url value="/Backstage/banGroupServlet" />"
						...
						<ul class="nav nav-tabs" id="myTab">
							<li class="" onclick="removeChecked()"><font size="5">檢舉管理</font></a></li>
										...
										<div class="container">
											<div class="cart-info">
												<table class="table table-striped table-bordered"
													style="text-align:center; font-size: medium; margin-top: 15px">
													<tr>
														<th style="width:; text-align: center;" class="name">檢舉編號</th>
														<th style="width:; text-align: center;" class="quantity">會員姓名</th>
														<th style="width:; text-align: center;" class="model">檢舉分類</th>
														<th style="width:; text-align: center;" class="model">團編號/會員編號</th>
														<th style="width:; text-align: center;" class="model">檢舉原因</th>
													</tr>
