												...
												<table class="table table-striped table-bordered"
													...
													<tr>
														<td>內文<textarea cols="95"
																style="margin-top: 10px; width: 790px; height: 166px;"
																id="siteMailId" placeholder="請輸入內容" rows="5"
																name="siteMail"></textarea></td>
													</tr>
												</table>
													...
													<c:forEach var='bean' items='${Partmembers}'>
														<tr>
															<td style="text-align: center;"><input
																type="checkbox" name="checkbox" value=${bean.memberNo}></td>
															<td style="text-align: center;">${bean.memberNo}</td>
															<td style="text-align: center;">${bean.memberName}</td>
														</tr>
													</c:forEach>
												</table>
