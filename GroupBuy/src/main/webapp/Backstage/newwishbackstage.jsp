										...
										<div class="container">
											<div class="cart-info">
												<table class="table table-striped table-bordered"
													...
													<tr>
													<th style="width:; text-align: center;" class="name"></th>
														<th style="width:; text-align: center;" class="name">許願編號</th>
														<th style="width:; text-align: center;" class="quantity">許願標題</th>
														<th style="width:; text-align: center;" class="model">許願品名</th>
													</tr>
