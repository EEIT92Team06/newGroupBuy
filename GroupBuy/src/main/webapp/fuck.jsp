...
<body>
  ...
  <a href="Register.html" class="list-group-item">作業</a>
  <a href="Products.html" class="list-group-item">練習</a>
</div>
		    </div>
		    <div class="col-md-9">
		    <div class="jumbotron">
     	 ...
     	 <div class="form-group">
     	  ...
     	  <div class="form-group">
     	      <div class="col-lg-10 col-lg-offset-2">
     	         <button type="button" id="buttonSubmit" class="btn btn-primary">註冊</button>
     	       	<div id="message"></div>
     	      </div>
	...
	<div class="row">
			...
			<div class="col-md-4">
				<h2>jQueryUI</h2>
				<p>jQuery UI是一套JavaScript 函式庫，提供抽象化、可自訂主題的GUI控制項與動畫效果。基於jQuery JavaScript函式庫，可用來建構互動式的網際網路應用程式。在2007年9月約翰·雷西格於jquery.com部落格裡的一篇文章裡正式公諸於世[2]。最新的版本需要jQuery 2.1.1或更新的版本。</p>
				<p>
					<a class="btn btn-primary"
	...
	$('#username').blur(function() {
		...
		$.get('AccountCheck', {'name':name}, function(data) {
			$('#message').text(data);
			if(data == "帳號已存在"){
				$('#span1>span').removeClass().addClass("glyphicon glyphicon-remove-sign");
			}else{
				$('#span1>span').removeClass().addClass("glyphicon glyphicon-ok-sign");
			}
		});
	  });
	
	    //呼叫AccountCheck Servlet
		//檢查通過後換上 glyphicon glyphicon-ok-sign 圖示
        //檢查失敗後換上 glyphicon glyphicon-remove-sign 圖示
