...
public class MemberBean {
	...
	public String toString() {
		return "MemberBean [memberNo=" + memberNo + ", memberStatus=" + memberStatus + ", memberAccount="
				+ memberAccount + ", memberName=" + memberName + ", memberNickName=" + memberNickName + ", memberBirth="
				+ memberBirth + ", memberPhone=" + memberPhone + ", memberAddress=" + memberAddress + ", memberPic="
				+ memberPic + ", groupAttendanceTotalSuccess=" + groupAttendanceTotalSuccess
				+ ", groupAttendanceTotalQt=" + groupAttendanceTotalQt + ", groupCredit=" + groupCredit + "]";
	}
